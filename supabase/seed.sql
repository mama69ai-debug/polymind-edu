...
-- 插入課程
INSERT INTO courses (id, title, description, cover_url, price, instructor_id, status) VALUES
  ('00000000-0000-0000-0000-000000000101', 'AI 工程實作入門：從需求到上線', '用最短路徑打造可交付的 AI 專案：需求拆解、資料流程、部署與監控。', '/images/courses/course_1.png', 1490, '00000000-0000-0000-0000-000000000001', 'published');
